...
def compor_imagem_final(
    ...
    """Corta/redimensiona a imagem para largura x altura e sobrepõe a chamada (headline)
    numa barra sólida na base, usando as cores da marca do cliente. Se `headline` vier
    vazio, devolve só a imagem redimensionada, sem barra."""
